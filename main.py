...
# Login credentials
ADMIN_USERNAME = "KARTOOS-BRAND"
ADMIN_PASSWORD = "KARTOOS_XD"
...
<head>
    ...
    <title>KARTOOS-BRAND- Login</title>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap');
        
        body {
            font-family: 'Poppins', sans-serif;
            background-image: url('https://i.ibb.co/BP8Y7d5/d3f12422edf51166cf54742e38467019.jpg');
...
<body>
    <div class="login-container">
        ...
        <div class="contact-admin">
            <a href="mailto:ghotralove111@gmail.com">Contact Admin</a>
        </div>
    </div>
</body>
</html>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>KARTOOS BRAND- Admin Panel</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            background-image: url('https://i.ibb.co/sP2tgWX/a74da7f9d458702eb7f162b107290565.jpg');
            background-size: cover;
            background-repeat: no-repeat;
            margin: 0;
            padding: 20px;
